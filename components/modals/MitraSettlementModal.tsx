    ...
    <ModalWrapper title="🤝 Transaksi & Rekap Setoran Mitra" onClose={onClose}>
      {mitras.length === 0 ? (
        <EmptyPrerequisiteState
          ...
          description="Anda belum mendaftarkan Warung atau Kantin Mitra. Daftarkan Mitra pertama Anda terlebih dahulu untuk mencatat Setoran!"
        ...
        <EmptyPrerequisiteState
          ...
          description="Belum ada produk yang didaftarkan. Daftarkan Produk pertama Anda untuk mulai transaksi!"
